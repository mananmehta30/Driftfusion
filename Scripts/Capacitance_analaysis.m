...
%% Capacitance_Manan Analysis for ions
...
for i = 1:length(Ncat_array)
    figure(203)
    plot(Vappt, C_totalwo(i).N_cat(scanrate_index).k_scan)
    legstr_n3{i} = ['Ncat =', num2str(Ncat_array(i)), 'cm-3'];
    hold on
end
...
for i = 1:length(Ncat_array)
    figure(204)
    plot(Vappt, C_ionicwo(i).N_cat(scanrate_index).k_scan)
    legstr_n3{i} = ['Ncat =', num2str(Ncat_array(i)), 'cm-3'];
    hold on
end
...
for i = 1:length(Ncat_array)
    figure(205)
    plot(Vappt, C_electronicwo(i).N_cat(scanrate_index).k_scan)
    legstr_n3{i} = ['Ncat =', num2str(Ncat_array(i)), 'cm-3'];
    hold on
end
...
for i = 1:length(kscan_array)
    figure(203)
    plot(Vappt, C_totalwo(ion_concentration_index).N_cat(i).k_scan)
    legstr_n3{i} = ['kscan=', num2str(kscan_array(i)), 'V/s'];
    hold on
end
...
for i = 1:length(kscan_array)
    figure(204)
    plot(Vappt, C_ionicwo(ion_concentration_index).N_cat(i).k_scan)
    legstr_n3{i} = ['kscan=', num2str(kscan_array(i)), 'V/s'];
    hold on
end
...
for i = 1:length(kscan_array)
    figure(205)
    plot(Vappt, C_electronicwo(ion_concentration_index).N_cat(i).k_scan)
    legstr_n3{i} = ['kscan=', num2str(kscan_array(i)), 'V/s'];
    hold on
end
